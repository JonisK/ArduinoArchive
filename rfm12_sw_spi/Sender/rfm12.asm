...
;--------------------------------------------------------
	...
	extern	_eeprom_read
	extern	_rfm12_init_tx
	extern	_rfm12_init_rx
	extern	_ADCON0_bits
	extern	_ADCON1_bits
...
;--------------------------------------------------------
	global	_rfm12_spi16
	global	_rfm12_wait
	global	_rfm12_dis_rx
	global	_rfm12_ena_rx
	global	_rfm12_rcv_msg
	global	_rfm12_snd_msg
	global	_rfm12_init
...
;***
;entry:  _rfm12_spi16	;Function start
; 2 exit points
;has an exit
...
;; ***	popGetLabel  key=12, label offset 118
	GOTO	_00230_DS_
;genSkipc:3083: created from rifx:0xbfe7aa80
;; gen.c:2261:resultRemat *{*
;; gen.c:2261:resultRemat *{*
;; gen.c:3504:ifxForOp *{*
;; ***	ifxForOp  3506
...
;  pBlock Stats: dbName = C
;***
;entry:  _rfm12_wait	;Function start
; 2 exit points
;has an exit
...
;  pBlock Stats: dbName = C
;***
;entry:  _rfm12_dis_rx	;Function start
; 2 exit points
;has an exit
;functions called:
;   _rfm12_spi16
...
;  pBlock Stats: dbName = C
;***
;entry:  _rfm12_ena_rx	;Function start
; 2 exit points
;has an exit
;functions called:
;   _rfm12_spi16
...
;  pBlock Stats: dbName = C
;***
;entry:  _rfm12_rcv_msg	;Function start
; 2 exit points
;has an exit
;functions called:
;   _rfm12_spi16
...
;  pBlock Stats: dbName = C
;***
;entry:  _rfm12_snd_msg	;Function start
; 2 exit points
;has an exit
;functions called:
;   _rfm12_spi16
...
;  pBlock Stats: dbName = C
;***
;entry:  _rfm12_init	;Function start
; 2 exit points
;has an exit
;functions called:
;   _rfm12_spi16
...
;	  502+  165 =   667 instructions ( 1664 byte)
