...
void setup() {
  ...
  // if the file is available, write to it:
   if (dataFile) {
    dataFile.println("Datenlogger_Rakete_v5 wurde gestartet.");
...
//      }
  ...
  Serial.println();
  Serial.print("X: ");
  Serial.print(rawmax[0] * SCALE, 8);
  Serial.println(" g");
  Serial.print("Y: ");
  Serial.print(rawmax[1] * SCALE, 8);
  Serial.println(" g");
  Serial.print("Z: ");
  Serial.print(rawmax[2] * SCALE, 8);
  Serial.println(" g");
  Serial.println();
