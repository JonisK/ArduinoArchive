This beta must be used with the latest beta or release version of SdFat.
...
adcTest.pde - Test program for development of McpSarAdc library.
...
These programs require the following three libraries to be installed:

BufferedWriter - Programs that speeds up writing text files.

McpSarAdc - Bit-bang SPI programs to read MicroChip Successive Aproximation
            Register ADCs, MCP3001, MCP3201 MCP3202, MCP3204, and MCP3208.
