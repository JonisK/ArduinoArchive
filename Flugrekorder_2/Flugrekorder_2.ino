...
// This example logs an Accelerometer at 440 Hz and a Magnetometer at 220 Hz
...
const uint32_t MAX_SYNC_TIME_MSEC = 3000;
...
// 	file.println(LOG_INTERVAL_USEC);
	...
	#endif
	I2c.write(ACC_ADDRESS, ACC_CTRL1, (uint8_t) B00111111); // normal mode, 1000Hz, XYZ enabled
	...
	OCR2A = 142;	// 2.272 ms, 440 Hz, 8 MHz, Prescaler 128				//156; // 2.5 ms, 400 Hz, 8 Mhz, Prescaler 128
