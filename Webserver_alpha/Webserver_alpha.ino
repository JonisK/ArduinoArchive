...
PROGMEM prog_char content_title3[] = "<h1>Jonis' Wohnung aus der Ferne steuern</h1>";
PROGMEM prog_char content_page3[] = "<hr /><h2>Ger&aumlte</h2>"
  "<h3>Verst&aumlrker Main</h3><p><form action=\"/page3\" method=\"POST\"><button name=\"LedOn\" value=\"\002\" type=\"submit\">Turn led \002</button><img src=\"led\002.png\" alt=\"Smiley face\" height=\"32\" width=\"32\" /></form></p>"
  "<h3>Verst&aumlrker Bass</h3><p>Status:<form action=\"/page3\" method=\"POST\"><button name=\"LedOn\" value=\"\002\" type=\"submit\">Switch it \002</button><img src=\"led\002.png\" alt=\"Smiley face\" height=\"32\" width=\"32\" /></form></p>";
