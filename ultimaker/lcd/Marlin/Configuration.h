...
#define STRING_CONFIG_H_AUTHOR "(Jack, for sanguinololu 1.3a)" // Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {53.333,53.333,3200/1.25,804}  // default steps per unit for Ultimaker
