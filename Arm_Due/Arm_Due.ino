...
float m_meridian = 2040.0; //Neutralspannung der Differenzierer
...
void loop()
{
  ...
  Serial << "{TIMEPLOT|data|w_1|T|" << w_1 << "}\n";
	Serial << "{TIMEPLOT|data|w_2|T|" << w_2 << "}\n";
  Serial << "{TIMEPLOT|data|x_1|T|" << x_1 << "}\n";
  Serial << "{TIMEPLOT|data|x_2|T|" << x_2 << "}\n";
	Serial << "{TIMEPLOT|data|x_3|T|" << x_3 << "}\n";
	Serial << "{TIMEPLOT|data|x_4|T|" << x_4 << "}\n";
